...
namespace gex
{
  namespace algorithm
  {
    namespace functor
    {
      ...
      /////////////////////////////////////////////////////////////
      // ForEach Point in TriangleMesh functor
      template<typename POINT, bool IS_CONST>
      ...
      /////////////////////////////////////////////////////////////
      // ForEach Point in PointCloud functor
      template<typename POINT, bool IS_CONST>
      struct ForEach<POINT,comp::PointCloud<typename POINT::Scalar>,IS_CONST>
      {
        GEX_ALGORITHM_FOREACH_TYPEDEFS(POINT,comp::PointCloud<typename POINT::Scalar>)

        template<typename FUNCTOR>
        void operator()(prim_ref_type _pointCloud, FUNCTOR f)
        {
          for (auto& _p : _pointCloud.points())
          {
            f(_p);
          }
        }
